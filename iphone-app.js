...
function IPhoneApp() {
  try {
      ...
      return (
        <div className="min-h-screen hero-background flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium">Loading iPhone 15 Pro...</p>
          </div>
        </div>
      );
    }
      ...
      <div className="min-h-screen hero-background relative overflow-hidden">
          ...
          <div className="nav-container">
            <div className="flex items-center justify-between h-12">
              ...
              <div className="flex items-center space-x-8">
                ...
                <span className="nav-item active">iPhone</span>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6">
          <div className="text-center mb-12 fade-in" style={{marginTop: '60px'}}>
            <h1 className="text-5xl font-light text-gray-900 mb-4">iPhone 15 Pro</h1>
            <p className="text-xl text-gray-600">Titanium. So strong. So light. So Pro.</p>
          </div>

          <div className="w-full max-w-2xl h-96 bg-white rounded-2xl shadow-lg flex items-center justify-center fade-in">
            <div className="text-center">
              <div className="icon-smartphone text-6xl text-gray-300 mb-4"></div>
    ...
    console.error('IPhoneApp component error:', error);
    return null;
  }
}

const root = ReactDOM.createRoot(document.getElementById('root'));
root.render(<ErrorBoundary><IPhoneApp /></ErrorBoundary>);